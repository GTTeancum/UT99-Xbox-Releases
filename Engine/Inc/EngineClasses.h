...
public:
    ...
    DECLARE_CLASS(ALevelInfo,AZoneInfo,0|CLASS_Config|CLASS_NativeReplication)
...
public:
    ...
    DECLARE_CLASS(APickup,AInventory,0|CLASS_NativeReplication)
    #include "APickup.h"
};
...
public:
    ...
    class AAmmo* PAmmo;
    DECLARE_CLASS(AAmmo,APickup,0|CLASS_NativeReplication)
    #include "AAmmo.h"
};
...
public:
    ...
    FLOAT FlareOffset;
    DECLARE_CLASS(AWeapon,AInventory,0|CLASS_NativeReplication)
    #include "AWeapon.h"
};
